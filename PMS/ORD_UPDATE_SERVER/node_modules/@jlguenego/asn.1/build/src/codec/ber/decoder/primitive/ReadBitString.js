...
exports.readBitString = void 0;
const misc_1 = require("../../../../misc");
function readBitString(cdv, length) {
    ...
    if (length === 1) {
        if (initialOctet !== 0) {
            ...
            throw new Error('The initial octet is zero, this bitstring should be empty');
        }
    }
    let value = '';
    ...
    return misc_1.formatBitString(value);
}
exports.readBitString = readBitString;
//# sourceMappingURL=ReadBitString.js.map