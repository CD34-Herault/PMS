...
export declare type Middleware = (req: IncomingMessage, res: ServerResponse, next: NextFunction) => void;
export declare type CookieToken = string;
export declare type MessageType = 'Unknown' | 'NTLM_NEGOTIATE_01' | 'NTLM_CHALLENGE_02' | 'NTLM_AUTHENTICATE_03' | 'Kerberos_1' | 'Kerberos_N';
export declare type NextFunction = (error?: Error) => void | Promise<void>;
...
export declare type ADUsers = ADUser[];
export interface CookieList {
    [name: string]: string;
}
export declare type SSOMethod = 'NTLM' | 'Kerberos' | undefined;
